<template>
  <GuestLayout title="Ingresa a tu cuenta">    
    <form class="mt-8 space-y-6" method="POST" @submit.prevent="login">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        <div>
          ...
          <input id="username" name="username" type="username" autocomplete="username" required="" v-model="user.username"
